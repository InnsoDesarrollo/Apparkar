...
public class VectorEditTextView extends AppCompatEditText {

    public VectorEditTextView(Context context) {
        super(context);
    }

    public VectorEditTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
    }

    public VectorEditTextView(Context context, AttributeSet attrs, int defStyleAttr) {
